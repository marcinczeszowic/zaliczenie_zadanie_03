...
malgorzata_bawarska.
filip_III_dobry.
izabela_corka_jana_I.
karol_zuchwaly.
izabela_corka_karola_de_bourbon.
maria_ks_burgundii.
maksymilian_I_Habsburg_cesarz.
...
parent(karol_VI_szalony,karol_V_madry).
parent(karol_VI_szalony,joanna_de_burbon).
parent(karol_VII,karol_VI_szalony).
parent(karol_VII_szalony,izabela_bawarska).
parent(ludwik_XI,karol_VII).
parent(ludwik_XI,maria).
parent(karol_VIII,ludwik_XI).
parent(karol_VIII,karolina_sabudzka).
parent(klaudia_walezjuszka,anna).
parent(klaudia_walezjuszka,ludwik_XII).
parent(henryk_II,klaudia_walezjuszka).
parent(henryk_II,franciszek_I).
parent(franciszek_II,henryk_II).
parent(franciszek_II,katarzyna_medycejska).
parent(karol_IX,henryk_II).
parent(karol_IX,katarzyna_medycejska).
parent(henryk_III,henryk_II).
parent(henryk_III,katarzyna_medycejska).
...
parent(malgorzata_kr_nawarry,karol_hr_angoleme).
parent(malgorzata_kr_nawarry,ludwika_sabudzka).
parent(joanna_d_albert,malgorzata_kr_nawarry).
parent(joanna_d_albert,henryk_III).
parent(henryk_IV,joanna_d_albert).
parent(henryk_IV,antoni_de_burbon).


parent(ludwik_I,jan_II_dobry).
parent(ludwik_I,bona).
parent(ludwik_II,ludwik_I).
parent(ludwik_II,maria).
parent(maria,ludwik_II).
...
parent(maria_ks_burgundii,izabela_corka_karola_de_bourbon).
...
male(karol).
male(jan).
male(karol_hr_angoleme).
male(henryk).
male(antoni_de_burbon).
male(henryk_IV).
male(franciszek_II).
male(karol_IX).
male(henryk_III).
...
male(karol_zuchwaly).
male(maksymilian_I_Habsburg_cesarz).
...
female(joanna).
female(bona).
female(joanna_de_burbon).
female(maria_corka_Karola_de_biois).
female(malgorzata_flandryjska).
female(izabela_bawarska).
female(marta).
female(karolina_sabudzka).
female(anna).
female(klaudia_walezjuszka).
female(walentyna).
...
female(maria_stuart).
female(elzbieta_hadsburg).
female(ludwika_lotarynska).
female(jolanta).
female(maria).
female(izabela_lotarynska).
female(jolanta_ks_lotaryngii).
female(maria_corka_Karola_I_de_bourbon).
female(malgorzata_bawarska).
